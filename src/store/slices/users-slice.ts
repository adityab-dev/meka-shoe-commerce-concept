...
const usersList: user[] = [
    { username: "1", password: "1", cart: [{ item: "", quantityInCart: 0 }] },
    { username: "2", password: "2", cart: [{ item: "", quantityInCart: 0 }] },
    { username: "3", password: "3", cart: [{ item: "", quantityInCart: 0 }] },
    { username: "4", password: "4", cart: [{ item: "", quantityInCart: 0 }] },
    { username: "5", password: "5", cart: [{ item: "", quantityInCart: 0 }] },
];
...
const usersSlice = createSlice({
    ...
    reducers: {
        ...
        addToCart(state, action: PayloadAction<{ item: string; username: string }>) {
